      ...
      {projects.length === 0 ? (
        ...
        <div className="grid gap-4 md:grid-cols-2">
          {projects.map((project) => {
            let statusClassName = "bg-gray-500/10 text-gray-400"
            ...
            return (
              <div
                key={project._id}
                className="space-y-2 rounded-xl border border-white/10 bg-gradient-to-br from-[#18181B] to-[#09090B] p-5"
              >
                <p className="font-medium">{project.name}</p>

                <span className={`rounded-md px-2 py-1 text-2xl ${statusClassName}`}>
